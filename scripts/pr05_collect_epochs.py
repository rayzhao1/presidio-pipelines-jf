...
if __name__ == '__main__':
    ...
    for stage, idx in sleep_stages:
        ...
        if not consecutive_interval_idx:
            print(f'Unable to retrieve {NUM_EPOCHS} consecutive epochs from {stage}.')
        ...
        start_time: datetime.datetime = txt_times[consecutive_interval_idx[0]]
        ...
        ieeg, time = ieeg_arr[start_idx: end_idx], time_arr[start_idx: end_idx]
